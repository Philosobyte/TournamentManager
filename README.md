...
### Installation
The latest unsigned apk may be downloaded and installed on the [releases page](https://github.com/Philosobyte/TournamentManager/releases). I am working on getting TournamentManager on the Google Play Store.
